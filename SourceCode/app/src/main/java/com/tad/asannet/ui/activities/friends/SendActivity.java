...
import com.tad.asannet.ui.activities.lottie.SendingActivity;
import com.tad.asannet.ui.activities.notification.ImagePreview;
import com.tad.asannet.ui.activities.notification.ImagePreviewSave;
...
import static com.tad.asannet.utils.Config.random;
                ...
                new MaterialDialog.Builder(this)
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                UCrop.of(imageUri, Uri.fromFile(new File(getCacheDir(), String.format("asannet_%s.png", random()))))
                                        .withOptions(options)
