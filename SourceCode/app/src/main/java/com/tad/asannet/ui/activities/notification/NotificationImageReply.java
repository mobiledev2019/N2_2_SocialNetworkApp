                ...
                if (!TextUtils.isEmpty(message_)) {
                    ...
                    mFirestore.collection("Users/" + user_id + "/Notifications_reply").add(notificationMessage).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            Toast.makeText(NotificationImageReply.this, "asannet sent!", Toast.LENGTH_SHORT).show();
                            message.setText("");
                        ...
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(NotificationImageReply.this, "Error sending asannet: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            mBar.setVisibility(View.GONE);
                        }
                    });
