package com.tad.asannet.adapters.searchFriends;
    ...
    public void onBindViewHolder(final ViewHolder holder,int position) {
        ...
        holder.exist_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setMessage("Biểu tượng này được hiển thị để cho biết rằng yêu cầu kết bạn với người dùng này đã được gửi đi.");
        ...
        holder.friend_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder dialog = new AlertDialog.Builder(context);
                dialog.setTitle("Thông báo");
                dialog.setMessage("Biểu tượng này được hiển thị để cho biết rằng người dùng đã là bạn của bạn.");
                dialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
