package com.tad.asannet.ui.activities;
...
import com.tad.asannet.models.DrawerItem;
import com.tad.asannet.models.Images;
import com.tad.asannet.models.SimpleItem;
import com.tad.asannet.ui.activities.account.LoginActivity;
import com.tad.asannet.ui.activities.account.UpdateAvailable;
import com.tad.asannet.ui.activities.friends.FriendProfile;
import com.tad.asannet.ui.activities.post.CommentsActivity;
import com.tad.asannet.ui.activities.post.PostImage;
import com.tad.asannet.ui.activities.post.PostText;
import com.tad.asannet.ui.activities.post.SinglePostView;
import com.tad.asannet.ui.fragment.Dashboard;
...
import com.tad.asannet.ui.fragment.FlashMessage;
import com.tad.asannet.ui.fragment.FriendsFragment;
import com.tad.asannet.ui.activities.notification.Notifications;
import com.tad.asannet.ui.fragment.ProfileFragment;
import com.tad.asannet.utils.Config;
import com.tad.asannet.utils.NetworkUtil;
...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
        ...
        switch (position) {
            ...
            case POS_SEND_MESSAGE:
                ...
                if(currentuser.isEmailVerified()) {
                    toolbar.setTitle("Gửi tin nhắn nhanh");
                    try {
                        getSupportActionBar().setTitle("Gửi tin nhắn nhanh");
                    } catch (Exception e) {
                        Log.e("Lỗi", e.getMessage());
                    }
                    this.invalidateOptionsMenu();
            ...
            case POS_LOGOUT:
                ...
                if (currentuser != null && isOnline()) {
                    ...
                    new MaterialDialog.Builder(this)
                            .title("Đăng xuất")
                            .content("Bạn có muốn đăng xuất khỏi tài khoản này?")
                            .positiveText("Có")
                    ...
                    new MaterialDialog.Builder(this)
                            .title("Đăng xuất")
                            .content("Một vài lỗi đã xảy ra khi đăng xuất, Kiểm tra kết nối mạng và thử lại.")
    ...
    public void logout() {
        ...
        mDialog.setMessage("Đang đăng xuất...");
        ...
        firestore.collection("Users").document(userId).update(tokenRemove).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MainActivity.this, "Lỗi đăng xuất", Toast.LENGTH_SHORT).show();
                mDialog.dismiss();
                Log.e("Lỗi Đăng xuất", e.getMessage());
            }
        });
               ...
               if (intent.getAction().equals(Config.PUSH_NOTIFICATION)) {
                    ...
                    switch (click_action) {
                        ...
                        case "com.tad.asannet.TARGET_COMMENT":
                            ...
                            break;
                        case "com.tad.asannet.TARGET_UPDATE":
