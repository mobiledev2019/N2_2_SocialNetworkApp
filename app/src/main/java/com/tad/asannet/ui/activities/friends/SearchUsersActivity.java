...
import com.tad.asannet.adapters.searchFriends.SearchFriendAdapter;
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
                if (viewHolder instanceof SearchFriendAdapter.ViewHolder) {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(findViewById(R.id.layout), "Đã gửi lời mời kết bạn đến " + name, Snackbar.LENGTH_LONG);
