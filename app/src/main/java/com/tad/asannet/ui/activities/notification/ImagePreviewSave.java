package com.tad.asannet.ui.activities.notification;
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            if (list.isEmpty()) {
                ...
                notification = mBuilder
                        ...
                        .setContentText("Image saved in /Downloads/asannet/" + sender_name)
                        .build();

                notificationManager.notify(0, notification);
                Toast.makeText(ctxt, "Image saved in /Downloads/asannet/" + sender_name, Toast.LENGTH_LONG).show();
            }
        }
       ...
       new MaterialDialog.Builder(this)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        ...
                        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/asannet Images/"+sender_name  + "/HFY_" +  System.currentTimeMillis() + ".jpeg");
